...
import { AdaptorIcon } from "../components/workflow/AdaptorIcon";

type Tab = "logs" | "input" | "output";

/**
 * The expanded job editor: code on the left, and a run inspector / log console
 * stacked on the right. This is the view you reach by expanding a step from
